...
__name(I, "I");
function d(l3, e = "") {
  let t = typeof l3 == "string" ? l3 : l3.source, n = { replace: /* @__PURE__ */ __name((i, r) => {
...
var pe = /* @__PURE__ */ __name((l3) => d(W).replace("hr", v).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*(?:\\n|$))|~~~)[^\\n]*(?:\\n|$)").replace("list", l3).replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", H).getRegex(), "pe");
var Ae = pe(/ {0,3}(?:[*+-]|1[.)])[ \t]+[^ \t\n]/);
var Ie = pe(/ {0,3}(?:[*+-]|\d{1,9}[.)])(?:[ \t]|\n|$)/);
...
var mt = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var fe = /* @__PURE__ */ __name((l3) => mt[l3], "fe");
function R(l3, e) {
  if (e) {
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
  ...
  inlineTokens(e, t = []) {
    ...
    if (this.tokens.links && e.includes("[")) {
      let s = this.tokenizer.rules.inline.reflinkSearch, u = /* @__PURE__ */ __name((a) => {
        let p = a.lastIndexOf("[");
...
// ../.wrangler/tmp/pages-j6q3HD/functionsRoutes-0.26129120213987245.mjs
var routes = [
  {
    routePath: "/api/login",
    mountPath: "/api",
...
// C:/Users/18801/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/18801/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-BUcZwo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-BUcZwo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5145835298341613.mjs.map
